...
public class Detergent extends StaticEntity {

	public Detergent(Handler handler, float x, float y, int width, int height) {
	...
	public void render(Graphics g) {
		g.drawImage(Assets.detergent, (int) x, (int) y, width, height, null);
