...
public class PaperBoard extends StaticEntity {

	public PaperBoard(Handler handler, float x, float y, int width, int height) {
	...
	public void render(Graphics g) {
		g.drawImage(Assets.paperBoard, (int) x, (int) y, width, height, null);
