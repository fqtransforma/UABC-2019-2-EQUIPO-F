...
public class FoodBag extends StaticEntity {

	public FoodBag(Handler handler, float x, float y, int width, int height) {
	...
	public void render(Graphics g) {
		g.drawImage(Assets.foodBag, (int) x, (int) y, width, height, null);
