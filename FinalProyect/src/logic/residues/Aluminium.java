...
public class Aluminium extends StaticEntity {

	public Aluminium(Handler handler, float x, float y, int width, int height) {
	...
	public void render(Graphics g) {
		g.drawImage(Assets.aluminium, (int) x, (int) y, width, height, null);
