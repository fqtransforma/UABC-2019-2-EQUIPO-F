...
public class Paper extends StaticEntity{



	public Paper(Handler handler, float x, float y, int width, int height) {
	...
	public void render(Graphics g) {
		g.drawImage(Assets.paper, (int) x, (int) y, width, height, null);
