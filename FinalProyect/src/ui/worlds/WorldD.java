...
import logic.residues.FinishedObject;
...
public class WorldD {
	...
	public static void init(Handler handler) {
		...
		subWorld_A = new World(handler, ".\\src\\data\\Textures\\world4a.txt", 4, 4);
		subWorld_B = new World(handler, ".\\src\\data\\Textures\\world4b.txt", 10, 10);
		subWorld_C = new World(handler, ".\\src\\data\\Textures\\world4c.txt", 30, 30);
		subWorld_D = new World(handler, ".\\src\\data\\Textures\\world4d.txt", 400, 400);
	...
	public static void initSubWorldA(Handler handler) {
		...
		subWorld_A.entityManager.addEntity(new PizzaBox(handler, 800, 250, 32, 32));
		subWorld_A.entityManager.addEntity(new Detergent(handler, 450, 100, 32, 32));
		...
		// Obstaculos
		subWorld_A.entityManager.addEntity(new RockPinch(handler, 300, 300, 32, 32, 0.05f, 100));
		subWorld_A.entityManager.addEntity(new RockPinch(handler, 500, 500, 32, 32, -0.05f, 100));
		subWorld_A.entityManager.addEntity(new RockPinch(handler, 600, 400, 32, 32, 0.05f, 100));
		...
		subWorld_A.entityManager.addEntity(new RockPinch(handler, 800, 300, 32, 32, -0.05f, 100));
		
		//***SEGUNDO MAPA***//
		
		// Botes de basura
		subWorld_B.entityManager.addEntity(new blueBin(handler, 320, 220, 32, 48));
		subWorld_B.entityManager.addEntity(new brownBin(handler, 250, 150, 32, 48));
		subWorld_B.entityManager.addEntity(new yellowBin(handler, 431, 320, 32, 48));
		subWorld_B.entityManager.addEntity(new GreenBin(handler, 270, 500, 32, 48));
		subWorld_B.entityManager.addEntity(new BlackBin(handler, 945, 50, 32, 48));

		// Decoracion
		subWorld_B.entityManager.addEntity(new Door(handler, 990, 32, 32, 128, 13));

		// Residuos
		subWorld_B.entityManager.addEntity(new banana(handler, 450, 40, 16, 32));
		subWorld_B.entityManager.addEntity(new bottle(handler, 50, 450, 16, 32));
		subWorld_B.entityManager.addEntity(new PaperBoard(handler, 37, 98, 16, 32));
		...
		subWorld_B.entityManager.addEntity(new PizzaBox(handler, 150, 200, 32, 32));
		subWorld_B.entityManager.addEntity(new Detergent(handler, 750, 200, 32, 32));
		subWorld_B.entityManager.addEntity(new FoodBag(handler, 950, 400, 32, 32));
		subWorld_B.entityManager.addEntity(new LargeBottle(handler, 500, 350, 16, 32));
		
		

		// Obstaculos
		subWorld_B.entityManager.addEntity(new RockPinch(handler, 450, 350, 32, 32, 0.1f, 100));
		subWorld_B.entityManager.addEntity(new RockPinch(handler, 900, 120, 32, 32, -0.1f, 100));
		subWorld_B.entityManager.addEntity(new RockPinch(handler, 70, 250, 32, 32, 0.1f, 100));
		subWorld_B.entityManager.addEntity(new PinchDown(handler, 650, 450, 32, 32, 0, 600, 8));
		subWorld_B.entityManager.addEntity(new PinchRightLeft(handler, 200, 350, 32, 32, 0, 1024, 5));
		subWorld_B.entityManager.addEntity(new PinchRightLeft(handler, 25, 125, 32, 32, 0, 1024, 5));
		subWorld_B.entityManager.addEntity(new RockPinch(handler, 500, 400, 32, 32, -0.1f, 100));
		
		//***TERCER MAPA***//
		
		// Botes de basura
		subWorld_C.entityManager.addEntity(new blueBin(handler, 125, 75, 32, 48));
		...
		subWorld_C.entityManager.addEntity(new GreenBin(handler, 735, 250, 32, 48));
		subWorld_C.entityManager.addEntity(new BlackBin(handler, 160, 275, 32, 48));

		// Decoracion
		subWorld_C.entityManager.addEntity(new Door(handler, 790, 550, 64, 64, 13));
		...
		subWorld_C.entityManager.addEntity(new PaperBoard(handler, 350, 150, 16, 32));
		subWorld_C.entityManager.addEntity(new Glass(handler, 270, 200, 16, 32));
		subWorld_C.entityManager.addEntity(new Aluminium(handler, 650, 420, 16, 32));
		subWorld_C.entityManager.addEntity(new Paper(handler, 200, 300, 32, 16));
		subWorld_C.entityManager.addEntity(new Can(handler, 250, 430, 32, 32));
		...
		// Obstaculos
		subWorld_C.entityManager.addEntity(new RockPinch(handler, 50, 350, 32, 32, 0.05f, 100));
		subWorld_C.entityManager.addEntity(new RockPinch(handler, 300, 100, 32, 32, -0.05f, 100));
		subWorld_C.entityManager.addEntity(new RockPinch(handler, 450, 200, 32, 32, 0.05f, 100));
		...
		subWorld_C.entityManager.addEntity(new RockPinch(handler, 600, 900, 32, 32, -0.05f, 100));
		
		//***CUARTO MAPA***//
		
		// Botes de basura
		subWorld_D.entityManager.addEntity(new blueBin(handler, 200, 120, 32, 48));
		subWorld_D.entityManager.addEntity(new brownBin(handler, 765, 250, 32, 48));
		...
		subWorld_D.entityManager.addEntity(new BlackBin(handler, 870, 400, 32, 48));

		// Decoracion
		subWorld_D.entityManager.addEntity(new FinishedObject(handler, 0, 0, 0, 0, 14));

		// Residuos
		subWorld_D.entityManager.addEntity(new banana(handler, 100, 140, 16, 32));
		subWorld_D.entityManager.addEntity(new bottle(handler, 850, 340, 16, 32));
		...
		// Obstaculos
		subWorld_D.entityManager.addEntity(new RockPinch(handler, 50, 350, 32, 32, 0.1f, 100));
		subWorld_D.entityManager.addEntity(new RockPinch(handler, 300, 100, 32, 32, -0.1f, 100));
		subWorld_D.entityManager.addEntity(new RockPinch(handler, 450, 200, 32, 32, 0.1f, 100));
		...
		subWorld_D.entityManager.addEntity(new RockPinch(handler, 600, 900, 32, 32, -0.1f, 100));
		subWorld_D.entityManager.addEntity(new RockPinch(handler, 750, 100, 32, 32, -0.1f, 100));
